...
static void PrintRegisterFile_HTML()
{
	...
	fprintf(trace_out,
		...
		"<thead><tr><th colspan=4 align=left>Register file</th></tr></thead>\n"
		"<tbody>\n");
	for (r = 0; r < 8; ++r)
	{
		int c;
